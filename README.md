# vityarthiopensource
This project is a comprehensive Open Source Software (OSS) audit report focused on Git, one of the most widely used distributed version control systems in the world.
# OSS Audit — Git
...
| Field | Details |
|---|---|
| **Student Name** | *Sumit Tripathi* |
| **Registration Number** |  *24BAI10876*|
| **Chosen Software** | Git |
